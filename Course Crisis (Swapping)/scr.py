...
class Swapper:
    ...
    def Results(self):
        ...
        for pair in self.SwapPair:
            ...
            swap_str = (f"{student1.rollno} swapped from {student1.CurrCourse} {student1.CurrSec} to "
                        f"{student1.DesiredCourse} {student1.DesiredSection} with {student2.rollno} who swapped from "
